...
BUILD_TOOLS=${ANDROID_SDK_ROOT}/build-tools/29.0.2
TOOLCHAIN=${ANDROID_NDK_ROOT}/toolchains/llvm/prebuilt/linux-x86_64
NATIVE_APP_GLUE=${ANDROID_NDK_ROOT}/sources/android/native_app_glue
...
for ABI in $ABIS; do
	...
	$TOOLCHAIN/bin/ld.lld src/*.o -o android/build/lib/$ABI/libmain.so -shared \
		...
		-lraylib -lnative_app_glue -llog -landroid -lEGL -lGLESv2 -lOpenSLES -lc -lm -ldl --wrap=fopen # -latomic
done
...
javac -verbose -source 1.8 -target 1.8 -d android/build/obj \
	...
	-classpath ${ANDROID_SDK_ROOT}/platforms/android-29/android.jar:android/build/obj \
...
$BUILD_TOOLS/aapt package -f \
	...
	-I ${ANDROID_SDK_ROOT}/platforms/android-29/android.jar -F game.apk android/build/dex
...
#$BUILD_TOOLS/platform-tools/adb install -r game.apk
